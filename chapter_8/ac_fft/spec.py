...
class Frame:
    ...
    def _initialize_frame(self, frequencies, magnitudes):
        ...
        self.img_data = np.zeros((frequencies.size, config.N_SPEC_VIZ_SAMPLES))
        ...
        self.ax.set_xlabel(config.SPEC_VIZ_X_LABEL, **config.RAW_VIZ_LABEL_PARAMS)
        self.ax.set_ylabel(config.SPEC_VIZ_Y_LABEL, **config.RAW_VIZ_LABEL_PARAMS)
