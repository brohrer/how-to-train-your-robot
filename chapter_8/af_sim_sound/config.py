...
# Take a short break after each chunk of audio data is retrived.
LISTEN_WAIT = 0.001  # Seconds

# Take a short break after trying to read a queue and finding it empty.
EMPTY_Q_WAIT = 0.00  # Seconds
...
FFT_WINDOW_LENGTH = 100  # milliseconds
FFT_WINDOW_LENGTH_SHORT = 20  # milliseconds
FFT_WINDOW_LENGTH_MEDIUM = 100  # milliseconds
FFT_WINDOW_LENGTH_LONG = 500  # milliseconds
BINS_PER_OCTAVE = 12
LOW_CUTOFF = 30
...
N_SPEC_VIZ_SAMPLES = int(SPEC_VIZ_DURATION * CLOCK_FREQ_SPEC)
