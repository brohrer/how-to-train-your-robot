...
AUDIO_BLOCK_DURATION = 1 / (10.0 * CLOCK_FREQ_SPEC)
...
FFT_WINDOW_DURATION_XLONG = 1.0  # seconds

FFT_WINDOW_DURATION = FFT_WINDOW_DURATION_MEDIUM
MULTIFFT_WINDOW_DURATION = FFT_WINDOW_DURATION_SHORT

# How much to offset each FFT sample window from the last, in seconds.
FFT_STRIDE_DURATION = MULTIFFT_WINDOW_DURATION  / 5.0
...
NORM_INITIAL_PASSES = 2
NORM_CONTRACTION_RATE = 1e-7
NORM_EXPANSION_RATE = 1e6 * NORM_CONTRACTION_RATE
...
MULTISPEC_VIZ_HEIGHT = 2 * FFT_VIZ_HEIGHT
MULTISPEC_VIZ_N_Y_TICKS = 10

MULTISPEC_VIZ_CMAP = "cividis"
# MULTISPEC_VIZ_CMAP = "inferno"
# MULTISPEC_VIZ_CMAP = "plasma"
