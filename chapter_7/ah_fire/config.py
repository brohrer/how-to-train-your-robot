...
KEYPRESS_REFRACTORY_PERIOD = 0.20  # seconds
...
recoil_duration = 0.03  # seconds
RECOIL_SHAPE = np.ones(int(recoil_duration * CLOCK_FREQ_SIM))
RECOIL_MAGNITUDE = 15
...
POLY_PATHS["torpedo"] = torpedo_scale * np.array(
    [
        [-0.17, 0],
        [-0.02, 0.01],
        [-0.05, 0.05],
...
TORPEDO_BODY = {
    ...
    "v_y": 0.0,
    "v_rot": -10,
    "x_atoms": atom_params["torpedo"][:, 0],
    "y_atoms": atom_params["torpedo"][:, 1],
    "r_atoms": atom_params["torpedo"][:, 2],
    "m_atoms": atom_params["torpedo"][:, 3],
    "stiffness_atoms": atom_stiffness,
